...
public class Sql2oCategoryDaoTest {
    ...
    public void clearAllClearsAllCategories() throws Exception {
        ...
        categoryDao.addCategory(category);
        categoryDao.addCategory(otherCategory);
        int daoSize = categoryDao.getAllCategories().size();
        categoryDao.clearAllCategories();
        assertTrue(daoSize > 0 && daoSize > categoryDao.getAllCategories().size());
    }
    ...
    public void getAllTasksByCategoryReturnsTasksCorrectly() throws Exception {
        ...
        Task newTask = new Task("yard work","mow the lawn", categoryId);
        Task otherTask = new Task("yard work","pull weeds", categoryId);
        Task thirdTask = new Task("yard work","trim hedge", categoryId);
        taskDao.add(newTask);
